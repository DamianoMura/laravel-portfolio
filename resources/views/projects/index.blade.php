            ...
            <ul class="space-y-4">
              @foreach($projects as $project)
                <li class="flex flex-col p-4 border rounded-lg">
                  ...
                  <div class="px-8 m">{{$project->content}}</div>
                  <div class="px-4 py-2 mt-4 text-white bg-gray-600 rounded-lg text-end">
                    created at: {{$project->created_at}} | updated at: {{$project->updated_at}}
                  </div>
