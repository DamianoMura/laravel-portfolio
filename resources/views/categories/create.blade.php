  ...
  <x-slot name="header">
    <div class="flex items-center justify-between space-x-4">
      ...
      <div class="buttons">
        ...
        <a class="p-1 font-bold text-green-500 border-4 border-green-500 rounded-3xl hover:bg-green-500 hover:text-green-100 focus:outline-none focus:ring"
          href="{{route('categories.index')}}"><i class="fa-solid fa-folder-tree"></i> manage categories</a>
      </div>
    </div>
  </x-slot>
      ...
      <div class="overflow-hidden bg-white shadow-sm dark:bg-gray-800 sm:rounded-lg">
        <div class="p-6 bg-white border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700">
          <form method="POST" action="{{ route('categories.store') }}">
            ...
            <div>
              <button type="submit"
                class="px-4 py-2 font-bold bg-blue-500 rounded hover:bg-blue-700 focus:outline-none focus:ring">Create
                category</button>
            </div>
          </form>
        </div>
